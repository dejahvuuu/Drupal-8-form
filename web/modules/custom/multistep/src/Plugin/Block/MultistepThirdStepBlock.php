...
use Drupal\multistep\Plugin\Config\MultistepThirdStepBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'MultistepThirdStepBlock' block.
 *
 * @Block(
 *  id = "multistep_thirdstep_block",
 *  admin_label = @Translation("Multistep Thirdstep Block"),
 * )
 */
class MultistepThirdStepBlock extends MultistepCardBlockBase implements ContainerFactoryPluginInterface {

/**
   * @var $configurationInstance \Drupal\multistep\Plugin\Config\MultistepThirdStepBlockClass
   */
   ...
   * @param \Drupal\multistep\Plugin\Config\MultistepThirdStepBlockClass  $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, MultistepThirdStepBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('multistep.third_step_block')
    );
  }
