...
use Drupal\multistep\Plugin\Config\MultistepSecondStepBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'MultistepSecondStepBlock' block.
 *
 * @Block(
 *  id = "multistep_secondstep_block",
 *  admin_label = @Translation("Multistep Secondstep Block"),
 * )
 */
class MultistepSecondStepBlock extends MultistepCardBlockBase implements ContainerFactoryPluginInterface {

/**
   * @var $configurationInstance \Drupal\multistep\Plugin\Config\MultistepSecondStepBlockClass
   */
   ...
   * @param \Drupal\multistep\Plugin\Config\MultistepSecondStepBlockClass  $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, MultistepSecondStepBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('multistep.second_step_block')
    );
  }
